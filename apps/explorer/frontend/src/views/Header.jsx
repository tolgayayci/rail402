...
export default function Header({ v }) {
  return (
    <div style={css('border:2px solid var(--ink);background:var(--panel);')}>
      <div style={css('display:flex;justify-content:space-between;align-items:center;padding:12px 18px;flex-wrap:wrap;gap:12px;border-bottom:1.5px solid var(--ink);')}>
